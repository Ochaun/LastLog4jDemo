...
# Java & Minecraft 
curl --keepalive-time 600 -s -L https://launcher.mojang.com/v1/objects/886945bfb2b978778c3a0288fd7fab09d315b25f/server.jar -o server.jar
curl --keepalive-time 600 -s -L https://launcher.mojang.com/v1/objects/0f275bc1547d01fa5f56ba34bdc87d981ee12daf/client.jar -o client.jar
curl --keepalive-time 600 -s -L https://github.com/ojdkbuild/ojdkbuild/releases/download/1.8.0.111-1/java-1.8.0-openjdk-1.8.0.111-0.b15.el6_8.x86_64.zip -o java-1.8.0-openjdk-1.8.0.111-0.b15.el6_8.x86_64.zip
